...
import { User, Home, History, Trophy, Gamepad2 } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <nav className="fixed bottom-4 left-4 right-4 z-50 bg-background/80 backdrop-blur-xl border border-border px-6 py-4 rounded-[24px] shadow-xl md:top-4 md:bottom-auto md:max-w-2xl md:mx-auto">
