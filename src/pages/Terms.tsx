          ...
          <section>
            ...
            <div className="bg-card border border-border p-8 rounded-[2rem] space-y-6 text-sm text-muted-foreground leading-relaxed shadow-sm">
              ...
              <div>
                ...
                <p>Les transactions financières sont gérées par nos partenaires certifiés (FedaPay, GeniusPay). eGame Bénin n'a jamais accès à vos codes PIN ou informations de carte bancaire.</p>
              </div>
