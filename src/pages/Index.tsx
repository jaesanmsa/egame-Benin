        ...
        <section className="mb-12 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="flex bg-card border border-border rounded-xl p-1 h-10">
              ...
              <button onClick={() => setFilterType('Online')} className={`flex-1 rounded-lg text-[9px] font-bold transition-all flex items-center justify-center gap-1 ${filterType === 'Online' ? 'bg-cyan-600 text-white' : 'text-muted-foreground'}`}><Globe size={12} /> Online</button>
