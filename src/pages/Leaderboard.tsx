...
import { Trophy, ArrowLeft, ChevronRight, Award, Gamepad2, Medal } from 'lucide-react';
      ...
      >
        ...
        <div className="text-center z-10">
          <div className="flex items-center justify-center gap-1">
            <p className="font-black text-xs truncate max-w<dyad-write path="src/pages/Leaderboard.tsx" description="Compléter la page de classement avec le code manquant">
"use client";
